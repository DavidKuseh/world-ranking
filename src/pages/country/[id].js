                ...
                <div className={styles.container_right}>
                    <div className={styles.details_panel}>
                        ...
                        <div className={styles.details_panel_row}>
                            ...
                            <div className={styles.overview_value}>{country.subregion}</div>
                        </div>
                        ...
                        <div className={styles.details_panel_row}>
                            ...
                            <div className={styles.overview_value}>{country.nativeName}</div>
                        </div>

                        <div className={styles.details_panel_row}>
                            <div className={styles.details_panel_label}>Gini</div>
                            <div className={styles.overview_value}>{country.gini} %</div>
                        </div>
